...
For example, you might have the following file structure:
	...
	cracklifecmr/custom/my_custom_stuff/   <<< This subfolder will be added as a search custom
	cracklifecmr/custom/my_custom_stuff/models/custom_model.mdl
	cracklifecmr/custom/my_custom_stuff/materials/custom_material.vmt
	cracklifecmr/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	cracklifecmr/custom/some_mod.vpk       <<< This VPK will be added as a search custom
	cracklifecmr/custom/another_mod.vpk    <<< This VPK will be added as a search custom
...
Note that the following directory structure is NOT correct:
	...
	cracklifecmr/custom/models/my_model.mdl

That will add the directory "cracklifecmr/custom/models" as a search path, in which case the
